...
public class VideoPage extends Activity
    ...
    public void displayVideo(String videoId, int timeMillis){

        Intent intent = YouTubeStandalonePlayer.createVideoIntent(this, developer_key , videoId, timeMillis, autoplay, lightboxMode);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((VideoPage) activity).onSectionAttached(
